def construct_observation_resource(data, patient_id):
...
def construct_diagnose_resource(data, patient_id):
...
def construct_medical_statement_resource(data, patient_id):
    ...
    medication_dict["reasonReference"] = obs_result
